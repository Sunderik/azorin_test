...
class FabCircularMenu extends StatefulWidget {
  final FabCircularMenuState fcms = FabCircularMenuState();
  ...
  var state = FabCircularMenuState();

  @override
  FabCircularMenuState createState() {
    return this.state = new FabCircularMenuState();
  }
}
...
class _RingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
        Rect.fromLTWH(width! / 2, width! / 2, size.width - width!, size.height - width!), 0.0, 2 * pi, false, paint);
  }
